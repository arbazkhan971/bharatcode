...
const BharatCodeInfoToolName = "bharatcode_info"

//go:embed bharatcode_info.md
var bharatcodeInfoDescription string

type BharatCodeInfoParams struct{}

func NewBharatCodeInfoTool(
	...
	return fantasy.NewAgentTool(
		BharatCodeInfoToolName,
		bharatcodeInfoDescription,
		func(ctx context.Context, _ BharatCodeInfoParams, _ fantasy.ToolCall) (fantasy.ToolResponse, error) {
			return fantasy.NewTextResponse(buildBharatCodeInfo(cfg, lspManager, allSkills, activeSkills, skillTracker)), nil
		},
	)
}

func buildBharatCodeInfo(cfg *config.ConfigStore, lspManager *lsp.Manager, allSkills []*skills.Skill, activeSkills []*skills.Skill, skillTracker *skills.Tracker) string {
