...
func TestBharatCodeInfo_MinimalConfig(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildBharatCodeInfo(cfg, nil, nil, nil, nil)
...
func TestBharatCodeInfo_ConfigFiles(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(
		&config.Config{Providers: csync.NewMap[string, config.ProviderConfig]()},
		"/home/user/.config/bharatcode/bharatcode.json",
		"/project/.bharatcode/bharatcode.json",
	)
	output := buildBharatCodeInfo(cfg, nil, nil, nil, nil)
	require.Contains(t, output, "[config_files]")
	require.Contains(t, output, "/home/user/.config/bharatcode/bharatcode.json")
	require.Contains(t, output, "/project/.bharatcode/bharatcode.json")
}

func TestBharatCodeInfo_Models(t *testing.T) {
	t.Parallel()
...
func TestBharatCodeInfo_Providers(t *testing.T) {
	t.Parallel()
...
func TestBharatCodeInfo_DisabledProvidersOmitted(t *testing.T) {
	t.Parallel()
...
func TestBharatCodeInfo_LSPStates(t *testing.T) {
	t.Parallel()
	...
	output := buildBharatCodeInfo(cfg, mgr, nil, nil, nil)
...
func TestBharatCodeInfo_MCPStates(t *testing.T) {
	t.Parallel()
...
func TestBharatCodeInfo_YoloMode(t *testing.T) {
	t.Parallel()
...
func TestBharatCodeInfo_AllowedTools(t *testing.T) {
	t.Parallel()
...
func TestBharatCodeInfo_DisabledTools(t *testing.T) {
	t.Parallel()
...
func TestBharatCodeInfo_Options(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
		Options: &config.Options{
			DataDirectory:        "/Users/user/project/.bharatcode",
			Debug:                true,
	...
	require.Contains(t, output, "data_directory = /Users/user/project/.bharatcode")
	require.Contains(t, output, "debug = true")
}

func TestBharatCodeInfo_AutoSummarizeInversion(t *testing.T) {
	t.Parallel()
	...
	outputFalse := buildBharatCodeInfo(cfgFalse, nil, nil, nil, nil)
	...
	outputTrue := buildBharatCodeInfo(cfgTrue, nil, nil, nil, nil)
	require.Contains(t, outputTrue, "auto_summarize = true")
}

func TestBharatCodeInfo_NoSecrets(t *testing.T) {
	t.Parallel()
...
func TestBharatCodeInfo_DeterministicOrdering(t *testing.T) {
	t.Parallel()
...
func TestBharatCodeInfo_EmptySectionsOmitted(t *testing.T) {
	t.Parallel()
...
func TestBharatCodeInfo_ConfigStaleness_Clean(t *testing.T) {
	t.Parallel()

	dir := t.TempDir()
	configPath := filepath.Join(dir, "bharatcode.json")
	...
	output := buildBharatCodeInfo(store, nil, nil, nil, nil)
...
func TestBharatCodeInfo_ConfigStaleness_Dirty(t *testing.T) {
	t.Parallel()
...
func TestBharatCodeInfo_ConfigStaleness_MissingPath(t *testing.T) {
	t.Parallel()
...
func TestBharatCodeInfo_Skills_NoSkills(t *testing.T) {
	t.Parallel()
...
func TestBharatCodeInfo_Skills_MixedLoadedUnloaded(t *testing.T) {
	t.Parallel()

	allSkills := []*skills.Skill{
		{Name: "go-doc", Builtin: false},
		{Name: "bash", Builtin: false},
		{Name: "bharatcode-config", Builtin: true},
	}
	activeSkills := allSkills

	tracker := skills.NewTracker(activeSkills)
	tracker.MarkLoaded("bash")
	tracker.MarkLoaded("bharatcode-config")

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildBharatCodeInfo(cfg, nil, allSkills, activeSkills, tracker)
	require.Contains(t, output, "[skills]")
	require.Contains(t, output, "bash = user, loaded")
	require.Contains(t, output, "bharatcode-config = builtin, loaded")
	require.Contains(t, output, "go-doc = user, unloaded")
}

func TestBharatCodeInfo_Skills_DisabledSkills(t *testing.T) {
	t.Parallel()
	...
	require.Contains(t, output, "bharatcode-config = builtin, unloaded")
	require.Contains(t, output, "image-convert = user, disabled")
}

func TestBharatCodeInfo_Skills_Ordering(t *testing.T) {
	t.Parallel()
...
func TestBharatCodeInfo_Skills_BuiltinOrigin(t *testing.T) {
	t.Parallel()
...
func TestBharatCodeInfo_Hooks(t *testing.T) {
	t.Parallel()
...
func TestBharatCodeInfo_Hooks_NoHooks(t *testing.T) {
	t.Parallel()
