...
func createTestLogFile(t *testing.T, entries []map[string]any) string {
	t.Helper()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "bharatcode.log")
...
func TestNewBharatCodeLogsTool(t *testing.T) {
	t.Parallel()
	tool := NewBharatCodeLogsTool("/tmp/test.log")
	require.NotNil(t, tool)
	require.Equal(t, BharatCodeLogsToolName, tool.Info().Name)
}

func TestBharatCodeLogs_HappyPath(t *testing.T) {
	t.Parallel()
	...
	result := runBharatCodeLogs(logFile, BharatCodeLogsParams{Lines: 3})
...
func TestBharatCodeLogs_DefaultLines(t *testing.T) {
	t.Parallel()
	...
	result := runBharatCodeLogs(logFile, BharatCodeLogsParams{Lines: 0})
...
func TestBharatCodeLogs_MaxCap(t *testing.T) {
	t.Parallel()
	...
	result := runBharatCodeLogs(logFile, BharatCodeLogsParams{Lines: 200})

	lines := strings.Split(result, "\n")
	require.Len(t, lines, 100)
}

func TestBharatCodeLogs_MissingFile(t *testing.T) {
	t.Parallel()
	result := runBharatCodeLogs("/nonexistent/path/bharatcode.log", BharatCodeLogsParams{Lines: 50})
	require.Contains(t, result, "No log file found")
}

func TestBharatCodeLogs_EmptyFile(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "bharatcode.log")
	...
	result := runBharatCodeLogs(logFile, BharatCodeLogsParams{Lines: 50})
	require.Contains(t, result, "Log file is empty")
}

func TestBharatCodeLogs_MalformedLines(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "bharatcode.log")
	...
	result := runBharatCodeLogs(logFile, BharatCodeLogsParams{Lines: 10})
...
func TestBharatCodeLogs_ExtraFieldsSorted(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
	...
	result := runBharatCodeLogs(logFile, BharatCodeLogsParams{Lines: 1})
...
func TestBharatCodeLogs_NonStringValues(t *testing.T) {
	t.Parallel()
	entry := map[string]any{
...
func TestBharatCodeLogs_Redaction(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
...
func TestBharatCodeLogs_ReservedFields(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
		{
			"time":   time.Now().Format(time.RFC3339),
...
func TestBharatCodeLogs_OversizedLines(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "bharatcode.log")
...
func TestBharatCodeLogs_PartialTrailingLine(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "bharatcode.log")
...
func TestBharatCodeLogs_ValueQuoting(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
...
func TestBharatCodeLogs_ChronologicalOrder(t *testing.T) {
	t.Parallel()
...
func TestBharatCodeLogs_TimeOnlyFormat(t *testing.T) {
	t.Parallel()
	entry := map[string]any{
...
func TestBharatCodeLogs_LevelVariations(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
	...
	result := runBharatCodeLogs(logFile, BharatCodeLogsParams{Lines: 5})
...
func TestBharatCodeLogs_SourceVariations(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
