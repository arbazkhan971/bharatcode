...
bharatcode update-providers https://example.com/providers.json

# Update Catwalk providers from a local file
bharatcode update-providers /path/to/local-providers.json

# Update Catwalk providers from embedded version
bharatcode update-providers embedded

# Update Hyper provider information
bharatcode update-providers --source=hyper

# Update Hyper from a custom URL
bharatcode update-providers --source=hyper https://hyper.example.com
`,
