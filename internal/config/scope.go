...
const (
	// ScopeGlobal targets the global data config (~/.local/share/bharatcode/bharatcode.json).
	ScopeGlobal Scope = iota
	// ScopeWorkspace targets the workspace config (.bharatcode/bharatcode.json).
	ScopeWorkspace
)
