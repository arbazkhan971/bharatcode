...
// fully detached from BharatCode's controlling terminal. This prevents shells
...
// It also prevents child processes from sending signals to BharatCode's process
// group.
...
// from BharatCode's session and controlling terminal.
//
