...
type (
	...
	// ActionStartGoal starts the autonomous /goal outer loop. When Goal is
	// empty (e.g. selected from the command palette) the UI prefills the
	// editor with "/goal " and lets the user type the objective.
	ActionStartGoal struct {
		Goal string
	}
