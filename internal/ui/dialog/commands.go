...
import (
	...
	"github.com/arbazkhan971/bharatcode/internal/ui/list"
...
func (c *Commands) defaultCommands() []*CommandItem {
	...
	// Goal Mode: autonomous multi-turn loop toward an objective. Available
	// even without a session; sending the kickoff prompt auto-creates one.
	commands = append(commands, NewCommandItem(c.com.Styles, "goal", "Goal Mode", "", ActionStartGoal{}))
