...
import (
	...
	"github.com/arbazkhan971/bharatcode/internal/ui/diffview"
)
...
type Styles struct {
	...
	// BharatCode's background. Defining them here keeps output readable and
	...
	Header struct {
		...
		LogoGradCanvas    lipgloss.Style // Canvas for the compact "BHARATCODE" gradient
		LogoGradFromColor color.Color    // "BHARATCODE" wordmark gradient start
		LogoGradToColor   color.Color    // "BHARATCODE" wordmark gradient end
	}
	...
	Logo struct {
		...
		SmallGradFromColor color.Color    // Small "BharatCode" wordmark gradient start
		SmallGradToColor   color.Color    // Small "BharatCode" wordmark gradient end
	}
